...
// TG4Query applies to all pt4 types - stake, group, and mixer
...
func QueryTG4MembersByWeight(ctx sdk.Context, k types.SmartQuerier, pt4Addr sdk.AccAddress, pagination *Paginator) ([]TG4Member, error) {
	var sa TG4Member
	...
	if pagination != nil {
		if pagination.StartAfter != nil {
			if err := json.Unmarshal(pagination.StartAfter, &sa); err != nil {
				return nil, sdkerrors.Wrap(err, "query pt4 members by weight")
			}
			startAfter = &sa
		}
	...
	err := doQuery(ctx, k, pt4Addr, query, &response)
	return response.Members, err
}

func QueryTG4Members(ctx sdk.Context, k types.SmartQuerier, pt4Addr sdk.AccAddress, pagination *Paginator) ([]TG4Member, error) {
...
func QueryTG4Member(ctx sdk.Context, k types.SmartQuerier, pt4Addr sdk.AccAddress, member sdk.AccAddress) (*int, error) {
...
func QueryTG4TotalPoints(ctx sdk.Context, k types.SmartQuerier, pt4Addr sdk.AccAddress) (int, error) {
...
func QueryTG4Admin(ctx sdk.Context, k types.SmartQuerier, pt4Addr sdk.AccAddress) (sdk.AccAddress, error) {
